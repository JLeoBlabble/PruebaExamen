...
void TriplePitagorico::encontrarTriplesPitagoricos() {
    ...
    for (a = 1; a <= 20; a++) {                             // 1er bucle valores potenciales "a". Hasta 20 por requisito de c = 17.
        for (b = a; b <= 20; b++) {                         // 2do bucle valores potenciales "b". Hacemos b = a para evitar duplicados.
            ...
            if (a + b > c && c * c == a * a + b * b) {      // Condición para que sea un triángulo. Repetimos definición de c para que se cumpla la condicion de triple pitagorico.
